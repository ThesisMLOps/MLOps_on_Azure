...
def parse_args():
    ...
    parser.add_argument("--table_name", type=str, help="ADX Monitoring Table Name", default="hmdamonitoring")
...
def main():
    ...
    prep_data = command( 
        ...
        command="python prep.py \
                ...
                --train_data_rai ${{outputs.train_data_rai}}  \
                --test_data_rai ${{outputs.test_data_rai}} \
        ...
        outputs={
            ...
            "train_data_rai": Output(type="mltable"),
            "test_data_rai": Output(type="mltable"),            
            }
    )
    ...
    def hmda_training_pipeline(raw_data, enable_monitoring, table_name):
        ...
        evaluate = evaluate_model(
            model_name="hmda-rai-downgraded-skl",
        ...
        return {
            "train_data": prep.outputs.train_data,
            "test_data": prep.outputs.test_data,
            "train_data_rai": prep.outputs.train_data_rai,
            "test_data_rai": prep.outputs.test_data_rai,            
            "trained_model": train.outputs.model_output,
            "score_report": evaluate.outputs.evaluation_output,
        }
